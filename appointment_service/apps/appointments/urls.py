...
urlpatterns = [
    path('appointments/providers/<uuid:provider_id>/schedules', ScheduleListCreateView.as_view(), name='schedule-list-create'),
    path('appointments/providers/<uuid:provider_id>/slots/generate', GenerateSlotsView.as_view(), name='slots-generate'),
    path('appointments/providers/<uuid:provider_id>/slots', SlotListView.as_view(), name='slots-list'),
